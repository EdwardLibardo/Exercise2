...
import com.automation.training.pages.SearchResultsSpecialPage;
...
public class WikiTests extends BaseTests{
	...
	public void testWikiSearch() throws IOException {
		...
		SearchResultsSpecialPage searchResultsSpecialPage = articlePage.search("Hola Mundo");
		Assert.assertEquals(searchResultsSpecialPage.getPageTitle(), "Search results");
		searchResultsSpecialPage.isThePageSearchingTheRighText("Hola Mundo");
